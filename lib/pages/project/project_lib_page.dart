...
import 'package:homework5/pages/project/project_detail_pages.dart';
...
class _ProjectListPageState extends State<ProjectListPage> {
  List<Project> projects = [
    Project(
      ...
      projectDuration:'06 ก.พ. 2566 ถึง 06 มี.ค. 2566',
      ProjectArea:'ตำบลพลูตาหลวง อำเภอสัตหีบ จังหวัดชลบุรี (มูลนิธิบ้านครูบุญชูเพื่อเด็กพิเศษ)',
    ),
    Project(
      ...
      donateCount: 8,
      imageUrl: 'assets/images/pizza.jpg',
      projectDuration:'01 ก.พ. 2566 ถึง 30 มิ.ย. 2566',
      ProjectArea:'ภาคตะวันออกเฉียงเหนือ ภาคตะวันตกและภาคใต้ของประเทศไทย',
    ),
    Project(
      ...
      donateCount: 28,
      imageUrl: 'assets/images/pizza.jpg',
      projectDuration:'01 ก.พ. 2566 ถึง 31 ม.ค. 2567',
      ProjectArea:'ตำบลลานสัก อำเภอลานสัก จังหวัดอุทัยธานี (เขตรักษาพันธุ์สัตว์ป่าห้วยขาแข้งและพื้นที่โดยรอบ), ตำบลไชยมงคล อำเภอเมืองนครราชสีมา จังหวัดนครราชสีมา (สวนสัตว์นครราชสีมา)',
    )
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(project.description, style:descriptionStyle,maxLines: 2,),
